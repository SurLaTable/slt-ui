...
class SelectInput extends React.Component {
  constructor(...args) {
    ...
    return _temp = super(...args), this.state = {
      open: false
    }, this.ignoreNextBlur = false, this.displayNode = null, this.displayWidth = null, this.isOpenControlled = this.props.open !== undefined, this.isControlled = this.props.value != null, this.update = this.isOpenControlled ? ({ event, open }) => {
      if (open) {
